...
import { Circle, Edit3, Trash2, ChevronUp, ChevronDown, Clock, AlertCircle, Tag, CheckCircle2 } from "lucide-react";
                ...
                <div className="flex-1 space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <p className="text-sm font-medium text-[#f2efeb] leading-[1.5]">{task.text}</p>
                    </div>
