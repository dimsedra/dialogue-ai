...
import { Flame, Check, CircleSlash, MessageSquarePlus, PencilLine } from "lucide-react";
    ...
    return (
      ...
      >
        <div className="w-16 h-16 rounded-3xl bg-[#1f1d19] border border-[#2a2723] flex items-center justify-center">
          <Flame className="w-6 h-6 text-[#d4a373]/20" />
        </div>
        <div className="space-y-1">
          <p className="text-sm font-bold text-[#a8a29e]/50 uppercase tracking-widest">No Habits</p>
          <p className="text-xs text-[#a8a29e]/30">Ask the AI to set up habits to start tracking.</p>
        </div>
      </motion.div>
    );
  }
